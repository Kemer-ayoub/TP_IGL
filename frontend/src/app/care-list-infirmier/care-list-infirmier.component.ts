...
@Component({
  selector: 'app-care-list-infirmier',
  imports: [CommonModule],
  templateUrl: './care-list-infirmier.component.html',
  styleUrl: './care-list-infirmier.component.css'
})
export class CareListInfirmierComponent {
