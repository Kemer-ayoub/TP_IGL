...
from .models import DPI, AntecedantMed, ExamRequest, ReportRequest, Ordonnance,Soin,BilanBiologique,BilanRadiologique
from .serializers import DPISerializer, AntecedantMedSerializer, ExamRequestSerializer, ReportRequestSerializer, OrdonnanceSerializer,BilanBiologiqueSerializer,BilanRadiologiqueSerializer,SoinSerializer
